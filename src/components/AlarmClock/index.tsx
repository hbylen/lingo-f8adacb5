import React, { useState, useEffect, useRef } from 'react';
    import { Clock, AlarmClockIcon, Play, Pause, RotateCcw, Volume2 } from 'lucide-react';
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 shadow-2xl border border-white/20 max-w-md w-full">
          ...
          <div className="mb-8">
            <h2 className="text-xl font-semibold text-white mb-4 flex items-center">
              <AlarmClockIcon className="w-5 h-5 mr-2" />
              設定鬧鐘
            </h2>
            <div className="flex gap-2 mb-4">
              ...
              <button
                onClick={addAlarm}
                className="px-4 py-2 bg-indigo-500 hover:bg-indigo-600 text-white rounded-lg transition-colors duration-200 font-medium"
              >
                新增
              </button>
            </div>
          ...
          <div className="mb-6">
            ...
            {alarms.length === 0 ? (
              <div className="text-center py-8 text-white/60">
                <AlarmClockIcon className="w-12 h-12 mx-auto mb-2 opacity-50" />
                <p>尚未設定任何鬧鐘</p>
              </div>
            ) : (
